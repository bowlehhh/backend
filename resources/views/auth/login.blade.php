                ...
                <form method="POST" action="{{ route('login.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email') }}" required placeholder="winkytiopratama@gmail.com" class="w-full pl-10 pr-4 py-3 bg-white border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none text-on-surface" />
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        <input id="remember" name="remember" type="checkbox" class="w-4 h-4 text-primary border-outline-variant rounded focus:ring-primary cursor-pointer" {{ old('remember') ? 'checked' : '' }} />
