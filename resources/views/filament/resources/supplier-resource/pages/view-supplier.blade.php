...
<x-filament-panels::page>
    ...
    <style>
      ...
      .sf-content { min-width: 0; width: calc(100% - var(--sf-sidebar-w)); margin-left: var(--sf-sidebar-w); height: calc(100vh - var(--sf-topbar-h)); min-height: 0; overflow-x: hidden; overflow-y: auto; -webkit-overflow-scrolling: touch; padding: 16px 16px 96px !important; }
      ...
      @media (max-width: 1279px) {
        ...
        .sf-content { width: 100%; margin-left: 0; height: auto; min-height: auto; overflow: visible; padding: 12px !important; }
      }
      ...
      <div class="sf-layout">
        ...
        <aside class="sf-sidebar flex flex-col w-full p-3 bg-white">
          ...
          <nav class="flex-1 flex flex-col space-y-1 overflow-y-auto pr-1">
            ...
            <a class="sf-nav-item flex items-center gap-3 text-[#47534d] px-2.5 py-2 hover:bg-[#eceef0] transition-all rounded-lg font-medium" href="{{ url('/admin/products') }}">
              <span class="material-symbols-outlined">inventory_2</span><span>Daftar Stok</span>
            </a>
            ...
            <a class="sf-nav-item flex items-center gap-3 text-[#47534d] px-2.5 py-2 hover:bg-[#eceef0] transition-all rounded-lg font-medium" href="{{ url('/admin/admin-module?type=product-groups') }}">
        ...
        <main class="sf-content p-4 md:p-6 space-y-4">
          <div class="rounded-xl border border-[#d4dbd7] bg-white p-4">
            <h1 class="sf-title font-display text-headline-lg text-on-surface leading-none">{{ $supplier->name }}</h1>
