...
<head>
    ...
    <title>Dashboard Admin Besar - <?php echo e(config('app.name', 'Surya Duta Multindo')); ?></title>
...
<div class="min-h-screen overflow-hidden bg-[#f7f9fb]">
    <aside class="hidden lg:flex fixed inset-y-0 left-0 z-30 w-[280px] flex-col border-r border-slate-300 bg-white">
        ...
        <nav class="flex-1 p-4 space-y-2">
            <a href="<?php echo e(route('admin.admin-besar.index')); ?>" class="flex items-center gap-3 rounded-xl bg-emerald-700 px-4 py-3 text-white shadow-sm">
                <span class="material-symbols-outlined">dashboard</span><span class="font-semibold">Admin Besar</span>
            </a>
            <a href="<?php echo e(route('admin.admin-besar.history')); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-slate-600 hover:bg-slate-100">
        ...
        <div class="mx-auto max-w-[1600px] space-y-6 px-4 py-4 lg:px-6 lg:py-6">
                ...
                <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-right">
                            <p class="text-sm font-semibold text-slate-900"><?php echo e($userName); ?></p>
            ...
            <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <p class="mt-2 text-3xl font-bold text-slate-900"><?php echo e(number_format((int) ($stats['total_transactions'] ?? 0), 0, ',', '.')); ?></p>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <p class="mt-2 text-3xl font-bold text-emerald-700"><?php echo e(number_format((int) ($stats['today_transactions'] ?? 0), 0, ',', '.')); ?></p>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <p class="mt-2 text-3xl font-bold text-indigo-600"><?php echo e(number_format((int) ($stats['month_transactions'] ?? 0), 0, ',', '.')); ?></p>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <p class="mt-2 text-2xl font-bold text-amber-700"><?php echo e($stats['total_value'] ?? 'Rp 0'); ?></p>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <p class="mt-2 text-3xl font-bold text-violet-700"><?php echo e(number_format((int) ($stats['admin_actions_today'] ?? 0), 0, ',', '.')); ?></p>
            ...
            <div class="flex flex-col gap-4 border-b border-emerald-100 px-5 py-4 md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="<?php echo e(route('admin.admin-besar.history')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-emerald-700 bg-white px-4 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-50">
            ...
            <div class="grid gap-3 p-5 md:grid-cols-2 xl:grid-cols-5">
                <div class="rounded-2xl border border-emerald-100 bg-white p-4 shadow-sm">
                    ...
                    <p class="mt-2 text-3xl font-bold text-slate-900"><?php echo e(number_format((int) ($companyRecap['summary']['company_count'] ?? 0), 0, ',', '.')); ?></p>
                ...
                <div class="rounded-2xl border border-emerald-100 bg-white p-4 shadow-sm">
                    ...
                    <p class="mt-2 text-3xl font-bold text-emerald-700"><?php echo e(number_format((int) ($companyRecap['summary']['invoice_count'] ?? 0), 0, ',', '.')); ?></p>
                ...
                <div class="rounded-2xl border border-emerald-100 bg-white p-4 shadow-sm">
                    ...
                    <p class="mt-2 text-3xl font-bold text-amber-600"><?php echo e(number_format((int) ($companyRecap['summary']['credit_count'] ?? 0), 0, ',', '.')); ?></p>
                ...
                <div class="rounded-2xl border border-emerald-100 bg-white p-4 shadow-sm">
                    ...
                    <p class="mt-2 text-3xl font-bold text-emerald-600"><?php echo e(number_format((int) ($companyRecap['summary']['lunas_count'] ?? 0), 0, ',', '.')); ?></p>
                ...
                <div class="rounded-2xl border border-emerald-100 bg-white p-4 shadow-sm">
                    ...
                    <p class="mt-2 text-2xl font-bold text-slate-900"><?php echo e($companyRecap['summary']['grand_total'] ?? 'Rp 0'); ?></p>
                    <p class="mt-1 text-sm text-slate-500">Total nilai semua perusahaan</p>
                </div>
            </div>

            <div class="space-y-4 px-5 pb-5">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $companyRecap['groups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <details class="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm" <?php echo e($loop->first ? 'open' : ''); ?>>
                        <summary class="flex cursor-pointer list-none items-start justify-between gap-4 px-5 py-4">
                            <div class="min-w-0">
                                <div class="flex flex-wrap items-center gap-3">
                                    <h3 class="truncate text-xl font-extrabold text-slate-900"><?php echo e($group['company_name']); ?></h3>
                                    <span class="inline-flex items-center rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-600">
                                        <?php echo e(number_format((int) ($group['invoice_count'] ?? 0), 0, ',', '.')); ?> Invoice
                                    </span>
                                </div>
                                <p class="mt-1 text-sm text-slate-500">Terakhir transaksi <?php echo e($group['last_transaction_at'] ?? '-'); ?></p>
                            </div>
                        ...
                        <div class="border-t border-slate-200 bg-slate-50/70 px-5 py-4">
                            <div class="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                                <div class="flex items-center justify-between gap-3 border-b border-slate-200 pb-3">
                                    ...
                                    <span class="inline-flex rounded-full bg-sky-100 px-3 py-1 text-xs font-semibold text-sky-700"><?php echo e(number_format((int) ($group['invoice_count'] ?? 0), 0, ',', '.')); ?> Invoice</span>
                                </div>

                                <div class="mt-4 space-y-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $group['invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div class="flex items-start justify-between gap-4 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
                                            <div class="min-w-0">
                                                ...
                                                <p class="mt-1 text-xs text-slate-500"><?php echo e($invoice['created_at']); ?></p>
                                            </div>
                                            <div class="shrink-0 text-right">
                                                <p class="font-semibold text-slate-900"><?php echo e($invoice['subtotal']); ?></p>
                                                <a href="<?php echo e($invoice['receipt_url']); ?>" class="mt-2 inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50">
                                ...
                                <div class="mt-4 flex flex-col gap-3 rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3 md:flex-row md:items-center md:justify-between">
                                    <div>
                                        ...
                                        <p class="mt-1 text-2xl font-bold text-slate-900"><?php echo e($group['grand_total'] ?? 'Rp 0'); ?></p>
                                    </div>
                                    <div class="flex flex-wrap gap-2">
                                        <span class="inline-flex rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700">Invoice <?php echo e(number_format((int) ($group['invoice_count'] ?? 0), 0, ',', '.')); ?></span>
                                        <span class="inline-flex rounded-full bg-amber-100 px-3 py-1 text-xs font-semibold text-amber-700">Kredit <?php echo e(number_format((int) ($group['credit_count'] ?? 0), 0, ',', '.')); ?></span>
                                        <span class="inline-flex rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-700">Lunas <?php echo e(number_format((int) ($group['lunas_count'] ?? 0), 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex flex-col gap-4 border-b border-slate-200 px-5 py-4 md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex flex-wrap gap-2">
                    <span class="inline-flex items-center rounded-full bg-sky-100 px-3 py-1 text-sm font-semibold text-sky-700">
                        <?php echo e(number_format((int) ($companyRecap['summary']['invoice_count'] ?? 0), 0, ',', '.')); ?> Invoice
                    </span>
                    <span class="inline-flex items-center rounded-full bg-emerald-100 px-3 py-1 text-sm font-semibold text-emerald-700">
                        <?php echo e($companyRecap['summary']['grand_total'] ?? 'Rp 0'); ?>
            ...
            <div class="overflow-x-auto scrollbar">
                <div class="grid gap-3 p-5 md:grid-cols-2 xl:grid-cols-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $invoiceRecap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a href="<?php echo e($invoice['receipt_url']); ?>" class="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-300 hover:shadow-md">
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    <p class="text-xs font-bold uppercase tracking-[0.18em] text-slate-400">Invoice</p>
                                    <h3 class="mt-2 text-lg font-extrabold text-slate-900 group-hover:text-emerald-700"><?php echo e($invoice['invoice_number']); ?></h3>
                                    <p class="mt-1 text-sm text-slate-500"><?php echo e($invoice['company_name']); ?></p>
                                </div>
                            ...
                            <div class="mt-4 flex items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p class="mt-1 text-base font-bold text-slate-900"><?php echo e($invoice['subtotal']); ?></p>
                                </div>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div class="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                    ...
                    <a href="<?php echo e(route('admin.admin-besar.history')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-emerald-700 px-4 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-50">
                        <span class="material-symbols-outlined text-[18px]">history</span>
                        Lihat History
                    </a>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-slate-200">
                        ...
                        <tbody class="divide-y divide-slate-100 bg-white">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr class="align-top">
                                    <td class="px-5 py-4">
                                        <p class="font-semibold text-slate-900"><?php echo e($trx['invoice']); ?></p>
                                        <p class="mt-1 text-xs text-slate-500"><?php echo e($trx['customer']); ?></p>
                                        <p class="mt-1 text-xs text-slate-500"><?php echo e(number_format((int) $trx['items_count'], 0, ',', '.')); ?> item</p>
                                    </td>
                                    <td class="px-5 py-4">
                                        <p class="font-semibold text-slate-900"><?php echo e($trx['cashier']); ?></p>
                                        <p class="mt-1 text-xs text-slate-500">Nota diterbitkan dari transaksi aktif</p>
                                    </td>
                                    <td class="px-5 py-4 font-semibold text-slate-900"><?php echo e($trx['subtotal']); ?></td>
                                    <td class="px-5 py-4 font-semibold text-emerald-700"><?php echo e($trx['total']); ?></td>
                                    <td class="px-5 py-4">
                                        <span class="inline-flex rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700"><?php echo e($trx['payment_method']); ?></span>
                                    </td>
                                    <td class="px-5 py-4 text-sm text-slate-600"><?php echo e($trx['created_at']); ?></td>
                                    <td class="px-5 py-4 text-right">
                                        <a href="<?php echo e($trx['receipt_url']); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-300 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
                                ...
                                <div class="flex items-start gap-3">
                                    <div class="mt-0.5 rounded-xl bg-white p-2 text-emerald-700 shadow-sm">
                                        <span class="material-symbols-outlined text-[20px]">
                                            <?php echo e($item['kind'] === 'activity' ? 'fact_check' : ($item['kind'] === 'stock' ? 'inventory_2' : ($item['kind'] === 'sale_edit' ? 'edit_note' : 'delete_forever'))); ?>

                                        </span>
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <div class="flex flex-wrap items-center gap-2">
                                            <h3 class="font-bold text-slate-900"><?php echo e($item['title']); ?></h3>
                                            <span class="rounded-full bg-white px-2.5 py-1 text-[11px] font-bold text-slate-600"><?php echo e($item['actor']); ?></span>
                                            <span class="rounded-full bg-emerald-100 px-2.5 py-1 text-[11px] font-bold text-emerald-700"><?php echo e($item['created_at']); ?></span>
                                        </div>
                                        <p class="mt-2 text-sm text-slate-700"><?php echo e($item['detail']); ?></p>
                                        <p class="mt-1 text-sm text-slate-500"><?php echo e($item['note']); ?></p>
                                        <p class="mt-2 text-xs font-semibold text-slate-600"><?php echo e($item['value']); ?></p>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($item['url'])): ?>
                                            <div class="mt-3">
                                                <a href="<?php echo e($item['url']); ?>" class="inline-flex items-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50">
                                                    Buka detail
                                                </a>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH /home/mrgana/pos-inventory/backend/resources/views/admin/admin-besar/dashboard.blade.php ENDPATH**/ ?>