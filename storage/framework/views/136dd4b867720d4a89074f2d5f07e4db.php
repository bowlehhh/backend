...
<div class="wrap">
        ...
        <tr>
            <td class="header-left">
                <div class="company">
                    ...
                    <p>Telp: <?php echo e($sale->cashier_phone ?: '08xx-xxxx-xxxx'); ?></p>
                </div>
            </td>
    ...
    <table class="item-table">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $sale->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            <tr>
                ...
                <td class="desc col-name"><strong><?php echo e($partName); ?></strong></td>
                <td class="desc col-part"><span style="font-size: 9px; color: #64748b;"><?php echo e($partNumber); ?></span></td>
                <td class="col-qty" style="text-align:center;"><?php echo e($item->qty); ?></td>
                <td class="col-unit" style="text-align:center;"><?php echo e($item->product?->unit ?: '-'); ?></td>
                <td class="num col-price">Rp <?php echo e(number_format((float) $item->price, 0, ',', '.')); ?></td>
    ...
    <table class="totals">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCredit): ?>
            ...
            <tr><td class="label">TOTAL CICILAN</td><td class="num">Rp <?php echo e(number_format($installmentPaid, 0, ',', '.')); ?></td></tr>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <tr><td class="label">SISA CICILAN</td><td class="num">Rp <?php echo e(number_format($creditOutstanding, 0, ',', '.')); ?></td></tr>
            <tr><td class="label">TEMPO KREDIT</td><td class="num"><?php echo e($creditDays > 0 ? ($creditDays . ' hari') : '-'); ?></td></tr>
        <?php else: ?>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCredit): ?>
            <tr><td class="label">JATUH TEMPO</td><td class="num"><?php echo e($sale->credit_due_date?->format('d M Y') ?: '-'); ?></td></tr>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCredit): ?>
            ...
            <td class="sign-col">
                <div class="sign-box">
                    ...
                    <div class="sign-bottom">
                        ...
                        <?php echo e($sale->cashier_phone ?: 'Kasir'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! request()->boolean('pdf')): ?>
        <div class="actions">
...
<?php /**PATH C:\laragon\www\backend\resources\views\cashier\receipt.blade.php ENDPATH**/ ?>