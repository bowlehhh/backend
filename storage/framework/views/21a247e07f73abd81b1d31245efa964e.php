...
<div class="h-screen overflow-hidden bg-[#f7f9fb]">
    <aside class="hidden lg:flex fixed inset-y-0 left-0 z-30 w-[260px] flex-col border-r border-slate-300 bg-white">
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <a href="<?php echo e(route('cashier.history')); ?>" class="flex items-center gap-3 rounded-xl bg-indigo-500 px-3 py-2 text-white">
    ...
    <main class="lg:ml-[260px] h-full overflow-y-auto p-4 lg:p-6">
        <div class="mb-4 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('cashier.dashboard')); ?>" class="rounded-xl border border-emerald-700 px-4 py-2 text-sm font-semibold text-emerald-700">Kembali ke Register</a>
        </div>
...
<?php /**PATH C:\laragon\www\backend\resources\views\cashier\history.blade.php ENDPATH**/ ?>