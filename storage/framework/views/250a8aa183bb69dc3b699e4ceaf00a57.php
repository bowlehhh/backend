    ...
    <div class="paper">
        <div class="head">
            <div>
                ...
                <p class="sub">No. Inv Supplier: <strong><?php echo e($supplierInvoiceNumber); ?></strong></p>
            </div>
            <div class="meta">
                <div>Tanggal Cetak: <?php echo e($printedAt->format('d M Y H:i')); ?></div>
                <div>Nomor Inv: #<?php echo e($batch->id); ?></div>
...
<?php /**PATH /home/mrgana/pos-inventory/backend/resources/views/admin/credit-receipt.blade.php ENDPATH**/ ?>