        ...
        <div class="sf-layout">
          ...
          <aside class="sf-sidebar flex flex-col w-full p-4 bg-surface">
            ...
            <nav class="flex-1 flex flex-col space-y-1 overflow-y-auto pr-1">
              <a class="sf-nav-item flex items-center gap-2.5 bg-primary text-on-primary rounded-lg px-3 py-2 font-medium" href="<?php echo e(url('/admin/products')); ?>">
              ...
              <div class="mt-auto space-y-1">
                ...
                <div class="ml-3 border-l border-outline-variant pl-3 py-1 space-y-1">
                  <a class="sf-nav-item w-full flex items-center gap-2 text-sm px-3 py-2 rounded-lg font-medium <?php echo e(request()->routeIs('admin.transaksi.dashboard') ? 'bg-primary-container text-on-primary' : 'text-on-surface-variant hover:bg-surface-container-high'); ?>" href="<?php echo e(route('admin.transaksi.dashboard')); ?>">
                    <span class="material-symbols-outlined text-[18px]">point_of_sale</span>
                    <span>Daftar Barang Jual</span>
                  </a>
                  <a class="sf-nav-item w-full flex items-center gap-2 text-sm px-3 py-2 rounded-lg font-medium <?php echo e(request()->routeIs('admin.transactions.drafts') ? 'bg-primary-container text-on-primary' : 'text-on-surface-variant hover:bg-surface-container-high'); ?>" href="<?php echo e(route('admin.transactions.drafts')); ?>">
                    <span class="material-symbols-outlined text-[18px]">draft</span>
                    <span>Draft Tertunda</span>
                  </a>
                  <a class="sf-nav-item w-full flex items-center gap-2 text-sm px-3 py-2 rounded-lg font-medium <?php echo e(request()->routeIs('admin.transactions.history*') ? 'bg-primary-container text-on-primary' : 'text-on-surface-variant hover:bg-surface-container-high'); ?>" href="<?php echo e(route('admin.transactions.history')); ?>">
          ...
          <main class="sf-content min-h-screen p-4 md:p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4 md:gap-5 mb-5">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                ?>
                <div class="bg-surface-container-lowest p-4 rounded-xl border border-outline-variant custom-shadow <?php echo e($isLowStockCard ? 'cursor-pointer hover:shadow-md transition-shadow' : ''); ?>" <?php if($isLowStockCard): ?> onclick="openLowStockModal()" <?php endif; ?>>
                  <div class="flex items-center gap-2.5 mb-2">
                    ...
                    <span class="text-on-surface-variant text-[13px] font-medium"><?php echo e($stat['label'] ?? '-'); ?></span>
                  </div>
                  <div class="sf-value <?php echo e(explode(' ', $variantClass)[0]); ?> font-bold leading-tight"><?php echo e($stat['value'] ?? '0'); ?></div>
                  <p class="text-[12px] mt-1 font-medium <?php echo e(explode(' ', $variantClass)[0]); ?>"><?php echo e($stat['description'] ?? '-'); ?></p>
                </div>
            ...
            <div class="sf-toolbar bg-surface-container-lowest p-3 md:p-3.5 rounded-t-xl border-x border-t border-outline-variant flex flex-wrap items-center gap-3 md:gap-4">
              <div class="flex flex-col gap-1 min-w-0 flex-1">
                ...
                <input id="globalSearchInput" type="text" value="<?php echo e($viewData['search'] ?? ''); ?>" placeholder="Cari part number, nama barang, kategori, merek, barcode..." class="bg-surface border border-outline-variant rounded-lg px-3 py-2 text-[13px] focus:ring-primary focus:border-primary" autocomplete="off" spellcheck="false">
              </div>
                  ...
                  <tbody class="divide-y divide-outline-variant" id="productTableBody">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                      ...
                      <tr class="hover:bg-surface-container-low transition-colors group" data-product-id="<?php echo e((int) ($product['id'] ?? 0)); ?>">
                        ...
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($condition !== '' ? $condition : '-'); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($product['created_at'] ?? '-'); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($product['category'] ?? '-'); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($product['brand'] ?? '-'); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($weightDisplay); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($unit); ?></td>
                        <td class="px-5 py-3.5">
                          <span class="px-2.5 py-1 rounded-full <?php echo e($low ? 'bg-red-100 text-red-700' : 'bg-emerald-100 text-emerald-700'); ?> text-[11px] font-semibold inline-flex items-center gap-1">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($low ? 'bg-red-500' : 'bg-emerald-500'); ?>"></span><?php echo e($stock); ?> <?php echo e($stockUnit); ?>

                          </span>
                        </td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($product['purchase_price'] ?? 'Rp 0'); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($product['selling_price'] ?? 'Rp 0'); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($expeditionCostDisplay); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($product['supplier_name'] ?? '-'); ?></td>
                        <td class="px-5 py-3.5 text-[13px]"><?php echo e($product['supplier_invoice_number'] ?? '-'); ?></td>
...
<?php endif; ?>
<?php /**PATH /home/mrgana/pos-inventory/backend/resources/views/filament/pages/admin-dashboard.blade.php ENDPATH**/ ?>