<div class="grid grid-cols-1 gap-3 md:grid-cols-2">
  <div>
    ...
    <input type="text" name="batch_code" class="w-full rounded-lg border border-outline-variant bg-surface px-3 py-2 text-[13px] focus:border-primary focus:outline-none" placeholder="<?php echo e($batchCodePlaceholder); ?>">
