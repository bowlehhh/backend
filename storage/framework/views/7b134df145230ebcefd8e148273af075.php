                ...
                <form method="POST" action="<?php echo e(route('login.store')); ?>" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" required placeholder="winkytiopratama@gmail.com" class="w-full rounded-2xl border border-[#c8d6ce] bg-white py-3 pl-10 pr-4 text-on-surface outline-none transition focus:border-primary focus:ring-4 focus:ring-primary/15" />
                        </div>
                    </div>
