        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="mb-4 rounded-2xl border border-slate-200 bg-white p-4 md:p-5">
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <a href="<?php echo e(route('admin.admin-besar.history.supplier.detail', ['pt' => $group['pt_name']])); ?>" class="inline-flex items-center justify-center rounded-xl border border-emerald-700 px-4 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-50">Detail</a>
                </div>
                <div class="mt-4 grid gap-3 md:grid-cols-4">
                    <div class="rounded-xl bg-slate-50 px-4 py-3"><p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Transaksi</p><p class="mt-1 text-lg font-bold text-slate-900"><?php echo e(number_format((int) $group['summary']['total_transaksi'])); ?> kali</p></div>
                    <div class="rounded-xl bg-slate-50 px-4 py-3"><p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Qty</p><p class="mt-1 text-lg font-bold text-slate-900"><?php echo e(number_format((int) $group['summary']['total_qty'])); ?></p></div>
                    <div class="rounded-xl bg-slate-50 px-4 py-3"><p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Total Nilai</p><p class="mt-1 text-lg font-bold text-slate-900"><?php echo e($group['summary']['total_nilai']); ?></p></div>
                    <div class="rounded-xl bg-slate-50 px-4 py-3"><p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Kredit / Lunas</p><p class="mt-1 text-lg font-bold text-slate-900"><?php echo e(number_format((int) $group['summary']['kredit'])); ?> / <?php echo e(number_format((int) $group['summary']['lunas'])); ?></p></div>
                </div>
            </div>
...
<?php /**PATH /home/mrgana/pos-inventory/backend/resources/views/admin/admin-besar/history-supplier.blade.php ENDPATH**/ ?>