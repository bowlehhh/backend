<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
  <div>
    ...
    <input type="text" name="batch_code" class="w-full rounded-xl border border-outline-variant bg-surface px-4 py-3 focus:border-primary focus:outline-none" placeholder="<?php echo e($batchCodePlaceholder); ?>">
  ...
  <div>
    ...
    <input type="text" name="processed_by" value="<?php echo e(auth()->user()?->name ?? ''); ?>" class="w-full rounded-xl border border-outline-variant bg-surface px-4 py-3 focus:border-primary focus:outline-none" placeholder="Nama petugas / admin">
...
<?php /**PATH C:\laragon\www\backend\resources\views/filament/pages/partials/batch-info-fields.blade.php ENDPATH**/ ?>