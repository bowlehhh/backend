<div class="rounded-[1.1rem] border border-outline-variant bg-surface p-3.5">
  ...
  <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
    ...
    <div>
      ...
      <input type="text" name="barcode" class="w-full rounded-lg border border-outline-variant bg-surface px-3 py-2 text-[13px] uppercase focus:border-primary focus:outline-none">
    ...
    <div>
      ...
      <input type="text" name="unit" class="w-full rounded-lg border border-outline-variant bg-surface px-3 py-2 text-[13px] uppercase focus:border-primary focus:outline-none" placeholder="PCS / UNIT / BOX">
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-[minmax(0,1fr)_140px]">
      <div>
        ...
        <input type="number" step="0.01" min="0" name="weight" class="w-full rounded-lg border border-outline-variant bg-surface px-3 py-2 text-[13px] focus:border-primary focus:outline-none" placeholder="0">
      ...
      <div class="sm:col-span-2 hidden" data-weight-unit-custom-wrap>
        ...
        <input type="text" name="weight_unit_custom" class="w-full rounded-lg border border-outline-variant bg-surface px-3 py-2 text-[13px] focus:border-primary focus:outline-none" placeholder="Contoh: sack, box, pack">
    ...
    <div>
      ...
      <input type="text" name="slug" class="w-full rounded-lg border border-outline-variant bg-surface px-3 py-2 text-[13px] focus:border-primary focus:outline-none" placeholder="Otomatis dari nama barang">
    ...
    <div class="md:col-span-2">
      <label class="flex items-center gap-3 rounded-lg border border-outline-variant bg-surface px-3 py-2">
        ...
        <input type="checkbox" name="is_active" value="1" class="h-4 w-4 rounded border-outline-variant text-primary focus:ring-primary" <?php if($isActiveDefault): echo 'checked'; endif; ?>>
        <span class="text-[12px] text-on-surface">Status aktif dijual</span>
      </label>
    </div>
  </div>
</div>
<?php /**PATH /home/mrgana/pos-inventory/backend/resources/views/filament/pages/partials/product-info-fields.blade.php ENDPATH**/ ?>