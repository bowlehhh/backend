        ...
        <aside class="sf-sidebar flex flex-col w-full p-4 pb-6 bg-white">
          ...
          <nav class="flex-1 min-h-0 flex flex-col space-y-1 overflow-y-auto">
            ...
            <div class="mt-auto space-y-1">
              <a class="sf-nav-item flex items-center gap-3 px-3 py-2 rounded-lg font-medium <?php echo e($type === 'product-groups' ? 'bg-[#006948] text-white' : 'text-[#47534d] hover:bg-[#eceef0]'); ?>" href="<?php echo e(url('/admin/admin-module?type=product-groups')); ?>"><span class="material-symbols-outlined">inventory_2</span><span class="nav-label">Kelompok Barang</span></a>
              <div class="ml-3 border-l border-[#d4dbd7] pl-3 py-1 space-y-1">
                <a class="sf-nav-item flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium <?php echo e(request()->routeIs('admin.transaksi.dashboard') ? 'bg-[#e8fff4] text-[#006948]' : 'text-[#52615a] hover:bg-[#f2f4f6]'); ?>" href="<?php echo e(route('admin.transaksi.dashboard')); ?>">
                  <span class="material-symbols-outlined text-[18px]">point_of_sale</span>
                  <span class="nav-label">Daftar Barang Jual</span>
                </a>
                <a class="sf-nav-item flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium <?php echo e(request()->routeIs('admin.transactions.drafts') ? 'bg-[#e8fff4] text-[#006948]' : 'text-[#52615a] hover:bg-[#f2f4f6]'); ?>" href="<?php echo e(route('admin.transactions.drafts')); ?>">
                  <span class="material-symbols-outlined text-[18px]">draft</span>
                  <span class="nav-label">Draft Tertunda</span>
                </a>
                <a class="sf-nav-item flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium <?php echo e(request()->routeIs('admin.transactions.history*') ? 'bg-[#e8fff4] text-[#006948]' : 'text-[#52615a] hover:bg-[#f2f4f6]'); ?>" href="<?php echo e(route('admin.transactions.history')); ?>">
        ...
        <main class="sf-main-scroll p-4 md:p-6">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'reports'): ?>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
              ...
              <div class="bg-white p-6 rounded-xl border border-[#d4dbd7] custom-shadow">
                ...
                <p class="text-sm text-[#52615a] mt-2"><?php echo e(number_format((int) ($reportStats['cashier_today_count'] ?? 0), 0, ',', '.')); ?> transaksi admin toko</p>
              </div>
            </div>
            ...
            <div class="mb-6 rounded-xl border border-[#d4dbd7] bg-white p-5 custom-shadow">
              <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-col gap-2 sm:flex-row">
                  <a href="<?php echo e(route('admin.transaksi.dashboard')); ?>" class="inline-flex items-center justify-center rounded-lg bg-[#006948] px-4 py-2 text-sm font-semibold text-white hover:brightness-95">
                    Buka Transaksi
                  </a>
                  <a href="<?php echo e(route('admin.transactions.drafts')); ?>" class="inline-flex items-center justify-center rounded-lg border border-[#bccac0] bg-white px-4 py-2 text-sm font-semibold text-[#006948] hover:bg-[#f1f4f2]">
                    Draft Tertunda
                  </a>
                  <a href="<?php echo e(route('admin.transactions.history')); ?>" class="inline-flex items-center justify-center rounded-lg border border-[#bccac0] bg-white px-4 py-2 text-sm font-semibold text-[#006948] hover:bg-[#f1f4f2]">
                    History &amp; Nota
                  </a>
                </div>
              </div>
          ...
          <?php elseif($type === 'credits'): ?>
            ...
            <div class="mb-4 flex flex-col gap-3 rounded-xl border border-[#d4dbd7] bg-white px-4 py-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <a
                href="<?php echo e(route('admin.credits.export.xlsx')); ?>"
                download="utang-saya-<?php echo e(now()->format('Ymd-His')); ?>.xlsx"
                ...
                <div class="rounded-xl border border-[#d4dbd7] bg-white p-5 custom-shadow">
                  ...
                  <form method="POST" action="<?php echo e(route('admin.users.update', $userRow['id'])); ?>" class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                      <label class="mb-1 block text-sm font-medium text-[#3d4a42]">Role</label>
                      <select name="role" class="w-full rounded-lg border-[#bccac0] focus:border-[#006948] focus:ring-[#006948]/20" required>
                        <option value="admin" <?php if($userRow['role'] === 'admin'): echo 'selected'; endif; ?>>Admin Toko/Gudang</option>
                        <option value="admin_besar" <?php if($userRow['role'] === 'admin_besar'): echo 'selected'; endif; ?>>Admin Besar</option>
                      </select>
                    </div>
                    <div class="flex items-end">
                      <label class="inline-flex items-center gap-2 rounded-lg border border-[#d4dbd7] px-3 py-2">
...
<?php endif; ?>
<?php /**PATH /home/mrgana/pos-inventory/backend/resources/views/filament/pages/admin-module.blade.php ENDPATH**/ ?>