...
<head>
    ...
    <title>Detail Barang - <?php echo e($product->barcode ?? '-'); ?></title>
...
<main class="mx-auto max-w-7xl p-4 md:p-6">
    <div class="mb-5 rounded-2xl border border-[#d4dbd7] bg-white px-5 py-4 card-shadow">
        <div class="flex flex-wrap items-start justify-between gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(route('admin.product-groups.receipt', ['product' => $product->id])); ?>" class="rounded-xl border border-[#bccac0] bg-white px-4 py-2 text-sm font-semibold text-[#006948] hover:bg-[#eef7f3]">Print Nota</a>
                <a href="<?php echo e(url('/admin/products')); ?>" class="rounded-xl border border-[#bccac0] bg-white px-4 py-2 text-sm font-semibold text-[#006948] hover:bg-[#eef7f3]">Kembali ke Barang</a>
                <a href="<?php echo e(url('/admin/admin-module?type=product-groups')); ?>" class="rounded-xl border border-[#bccac0] bg-white px-4 py-2 text-sm font-semibold text-[#006948] hover:bg-[#eef7f3]">Kelompok Barang</a>
            </div>
        </div>
    </div>
    ...
    <section class="mb-4 rounded-2xl border border-[#d4dbd7] bg-white overflow-hidden card-shadow">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 p-5">
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Part Number</p><p class="mt-1 text-2xl font-semibold"><?php echo e($product->barcode ?? '-'); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Nama Barang</p><p class="mt-1 text-2xl font-semibold"><?php echo e($product->name ?? '-'); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Kategori</p><p class="mt-1 text-2xl font-semibold"><?php echo e($product->category?->name ?? '-'); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Merek</p><p class="mt-1 text-2xl font-semibold"><?php echo e($product->brand?->name ?? '-'); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Unit</p><p class="mt-1 text-2xl font-semibold"><?php echo e($product->unit ?? '-'); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Stok Aktif</p><p class="mt-1 text-xl font-semibold"><?php echo e(number_format((int) ($product->batches->where('is_active', true)->sum('stock') ?? 0), 0, ',', '.')); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Pembelian Admin</p><p class="mt-1 text-xl font-semibold"><?php echo e(number_format((int) ($purchaseSummary['count'] ?? 0), 0, ',', '.')); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Transaksi Kasir</p><p class="mt-1 text-xl font-semibold"><?php echo e(number_format((int) ($salesSummary['count'] ?? 0), 0, ',', '.')); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Pembelian Lunas</p><p class="mt-1 text-xl font-semibold text-[#0f8a54]"><?php echo e(number_format((int) ($purchaseSummary['lunas'] ?? 0), 0, ',', '.')); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Pembelian Utang</p><p class="mt-1 text-xl font-semibold text-[#b42318]"><?php echo e(number_format((int) ($purchaseSummary['utang'] ?? 0), 0, ',', '.')); ?></p></div>
            <div><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Retur Kasir</p><p class="mt-1 text-xl font-semibold text-[#b36a00]"><?php echo e(number_format((int) ($salesSummary['retur'] ?? 0), 0, ',', '.')); ?></p></div>
            <div class="md:col-span-2"><p class="text-xs uppercase tracking-wide text-[#5c6b64]">Aktivitas Terakhir</p><p class="mt-1 text-xl font-semibold"><?php echo e($latestActivityAt?->format('d M Y H:i') ?? '-'); ?></p></div>
        </div>
    </section>
    ...
    <section class="mb-4 rounded-2xl border border-[#d4dbd7] bg-white p-5 card-shadow">
        <div class="mb-4 flex items-start justify-between gap-3">
            ...
            <div class="rounded-xl bg-[#eef7f3] px-4 py-2 text-sm text-[#006948] font-semibold">
                Total: <?php echo e($purchaseSummary['value'] ?? 'Rp 0'); ?>
                    ...
                    <div class="px-5 py-4">
                        <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                            ...
                            <div class="flex flex-wrap gap-2 text-sm">
                                <span class="inline-flex items-center rounded-full bg-[#e6fff3] px-3 py-1 font-semibold text-[#006948]">Transaksi <?php echo e(number_format((int) $monthGroup['summary']['count'], 0, ',', '.')); ?></span>
                                <span class="inline-flex items-center rounded-full bg-[#ececff] px-3 py-1 font-semibold text-[#4648d4]">Nilai <?php echo e($monthGroup['summary']['value']); ?></span>
                                <span class="inline-flex items-center rounded-full bg-[#fff4dd] px-3 py-1 font-semibold text-[#a36700]">Lunas <?php echo e(number_format((int) $monthGroup['summary']['lunas'], 0, ',', '.')); ?></span>
                                <span class="inline-flex items-center rounded-full bg-[#ffefdb] px-3 py-1 font-semibold text-[#b36a00]">Utang <?php echo e(number_format((int) $monthGroup['summary']['utang'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody class="divide-y divide-[#e4e8e6]">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $monthGroup['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="hover:bg-[#f6f8f7] transition-colors">
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['tanggal']); ?></td>
                                        <td class="px-5 py-4 font-semibold whitespace-nowrap"><?php echo e($row['supplier']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['processed_by'] ?? '-'); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['condition']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e(number_format((int) $row['qty'], 0, ',', '.')); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['harga_beli']); ?></td>
                                        <td class="px-5 py-4 font-semibold whitespace-nowrap"><?php echo e($row['total']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['down_payment']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['sisa_kredit']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['jatuh_tempo']); ?></td>
                                        ...
                                        <td class="px-5 py-4 whitespace-nowrap text-right">
                                            <a href="<?php echo e(route('admin.credits.receipt', ['batch' => $row['batch_id']])); ?>" class="inline-flex items-center rounded-lg border border-[#bccac0] bg-white px-3 py-1.5 text-sm text-[#006948] hover:bg-[#f1f4f2]">Print Nota</a>
                                        </td>
                                    </tr>
    ...
    <section class="rounded-2xl border border-[#d4dbd7] bg-white p-5 card-shadow">
        <div class="mb-4 flex items-start justify-between gap-3">
            ...
            <div class="rounded-xl bg-[#eef7f3] px-4 py-2 text-sm text-[#006948] font-semibold">
                Total: <?php echo e($salesSummary['value'] ?? 'Rp 0'); ?>
                    ...
                    <div class="px-5 py-4">
                        <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                            ...
                            <div class="flex flex-wrap gap-2 text-sm">
                                ...
                                <span class="inline-flex items-center rounded-full bg-[#ececff] px-3 py-1 font-semibold text-[#4648d4]">Nilai <?php echo e($monthGroup['summary']['value']); ?></span>
                                <span class="inline-flex items-center rounded-full bg-[#fff4dd] px-3 py-1 font-semibold text-[#a36700]">Lunas <?php echo e(number_format((int) $monthGroup['summary']['lunas'], 0, ',', '.')); ?></span>
                                <span class="inline-flex items-center rounded-full bg-[#ffefdb] px-3 py-1 font-semibold text-[#b36a00]">Kredit <?php echo e(number_format((int) $monthGroup['summary']['credit'], 0, ',', '.')); ?></span>
                                <span class="inline-flex items-center rounded-full bg-[#f4fbf7] px-3 py-1 font-semibold text-[#006948]">Retur <?php echo e(number_format((int) $monthGroup['summary']['retur'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="border-t border-[#d4dbd7] overflow-x-auto">
                        <table class="min-w-[1180px] w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-[#e4e8e6]">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_2 = true; $__currentLoopData = $monthGroup['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr class="hover:bg-[#f6f8f7] transition-colors">
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['tanggal']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['invoice']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap font-semibold"><?php echo e($row['customer']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['cashier']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e(number_format((int) $row['qty'], 0, ',', '.')); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap font-semibold"><?php echo e($row['total']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['payment_method']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap"><?php echo e($row['kredit']); ?></td>
                                        <td class="px-5 py-4 whitespace-nowrap">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($row['return_count'] ?? 0) > 0): ?>
                                                <span class="inline-flex rounded-full bg-[#eef7f3] px-3 py-1 text-xs font-semibold text-[#006948]">Retur <?php echo e(number_format((int) $row['return_count'], 0, ',', '.')); ?></span>
                                            <?php else: ?>
...
<?php /**PATH C:\laragon\www\backend\resources\views/admin/product-group-detail.blade.php ENDPATH**/ ?>